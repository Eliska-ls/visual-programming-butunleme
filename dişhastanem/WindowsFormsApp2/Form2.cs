...
namespace WindowsFormsApp2
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string yol = ("Data Source=LAPTOP-E0AAA6PN;Initial Catalog=Dishastanesi;Integrated Security=True");
                SqlConnection baglanti = new SqlConnection();
                baglanti.ConnectionString = yol;
                baglanti.Open();
                string ekleme = " INSERT INTO kullanici (ad,soyad,tc_no,kullanici_adi,sifre) VALUES (@ad,@soyad,@tc_no,@kullanici_adi,@sifre)";
